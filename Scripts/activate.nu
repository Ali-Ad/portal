...
let virtual-env = "C:\Users\Trainee\Envs\portalenv"
let bin = "Scripts"
let path-sep = ";"
...
let virtual_prompt = (if ("portalenv" != "") {
    "(portalenv) "
} {
...
alias deactivate = source "C:\Users\Trainee\Envs\portalenv\Scripts\deactivate.nu"
